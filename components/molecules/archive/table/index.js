...
const Index = () => {
    ...
    return (
        <div className='w-full'>
            <div className='mb-20 mt-10 md:mb-10 mx-24 md:mx-5 flex flex-col md:items-center '>
                <p className='uppercase font-normal text-xl tracking-[9px] text-neutral-400 ml-1'>All.</p>
                <h2 className='font-bold md:text-[4vw] text-5xl whitespace-nowrap  text-neutral-900'>My Project journey</h2>
            </div>
            <div className="mx-24 sm:w-full mt-10 flex flex-col mb-[3rem] ">
                <table>
                    <thead>
                        <tr className='font-extrabold text-xl text-blueGray-500'>
                    ...
                    <tbody>
                        {portofolio?.menu?.map((item, index) =>
                            <tr key={index} className=" hover:shadow-lg cursor-pointer text-blueGray-500 text-lg" >
